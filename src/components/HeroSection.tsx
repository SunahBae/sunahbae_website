        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              title="CV"
            >
              <img src="/images/icon-cv.png" alt="CV" className="w-5 h-5 object-contain" />
            </a>
            <a
              ...
              title="Email"
            >
              <img src="/images/icon-email.png" alt="Email" className="w-5 h-5 object-contain" />
            </a>
            <a
            ...
            >
              <img src="/images/icon-scholar.png" alt="Google Scholar" className="w-5 h-5 object-contain" />
            </a>
            <a
              ...
              title="LinkedIn"
            >
              <img src="/images/icon-linkedin.png" alt="LinkedIn" className="w-5 h-5 object-contain" />
            </a>
          </div>
        </div>
      </div>
