...
export const publications: Publication[] = [
  ...
  },
  {
    ...
    scope: 'Dom.',
    venue: 'Summer Conference of Society for Computational Design and Engineering, 2026',
    title: 'Designing an Augmented Reality-Based Explanation Interface for Understanding Multi-Device Automation Changes in Smart Homes (스마트홈의 다중 디바이스 자동화 변화 이해를 위한 증강현실 기반 설명 인터페이스 설계 )',
    authors: 'Yeongjo Kim, Yujeung Eum, Dahye Jeon, Sun Ah Bae, Seung Hyun Cha',
    year: '2026',
